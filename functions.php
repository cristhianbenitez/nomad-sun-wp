...
function nomad_sun_setup()
{
  ...
  add_theme_support(
    'custom-background',
    apply_filters('nomad_sun_custom_background_args', [
...
{
  wp_enqueue_style('nomad-sun-style', get_stylesheet_uri(), [], _S_VERSION);
  wp_enqueue_style(
    'tailwindcss',
    get_template_directory_uri() . '/css/tailwind.prod.css',
    [],
    filemtime(get_template_directory() . '/css/tailwind.prod.css'),
    'all'
  );
  wp_enqueue_script(
    'nomad-sun-barba',
